...
//        初始化各控件
        ...
        String weatheraString=prefs.getString("weather",null);
        if(weatheraString!=null){
            //有缓存时直接解析天气数据
            Weather weather= Utility.handleWeatherResponse(weatheraString);
...
//根据天气id请求城市天气信息
    public void requestWeather(final String weatherId){
        String weatherUrl = "http://guolin.tech/api/weather?cityid="+weatherId+
                "&key=0f36ee2e446d402c8d723337b0e22b0b";
